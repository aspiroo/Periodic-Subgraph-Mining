reference1 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\listMinerInputs.txt").read().strip()
reference2 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p8s3.txt")
reference3 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p8s4.txt")
reference4 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p9s3.txt")
reference5 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p9s4.txt")

fout1 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p8s3_new.txt", "w+")
fout2 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p8s4_new.txt", "w+")
fout3 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p9s3_new.txt", "w+")
fout4 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p9s4_new.txt", "w+")
...
p2s8 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p8s3_new.txt").read().strip()
splitReference2 = p2s8.split("\n")

p7s3 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p8s4_new.txt").read().strip()
splitReference3 = p7s3.split("\n")

p4s5 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p9s3_new.txt").read().strip()
splitReference4 = p4s5.split("\n")

p9s4 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p9s4_new.txt").read().strip()
...
for fileLine in splitReference2:
    ...
    out = open('D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p8s3_purity.txt', 'a')
    try:
...
for fileLine in splitReference3:
    ...
    out = open('D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p8s4_purity.txt', 'a')
    try:
...
for fileLine in splitReference4:
    ...
    out = open('D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p9s3_purity.txt', 'a')
    try:
...
for fileLine in splitReference5:
    ...
    out = open('D:\Studies & Researches\Researches\Periodic Subgraph Mining\purity\p9s4_purity.txt', 'a')
    try:
