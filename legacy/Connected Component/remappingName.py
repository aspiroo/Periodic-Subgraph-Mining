...
while i <= 101:
    ...
    list1 = ['gene1']
    list2 = ['gene2']
    reference = open('D:\Research\Periodic Subgraph Mining\Postprocessing\connected_compo\Gene Number 3\geneNumber'+str(i)+'.txt').read().strip()
    filetext = open("D:\Research\Periodic Subgraph Mining\Postprocessing\geneNamesWithLineNum.txt").read().strip()
    ...
    workbook = Workbook('D:\Research\Periodic Subgraph Mining\Postprocessing\connected_compo\Gene Name 3\connection'+str(i)+'.xlsx')
