reference1 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\\rest genes\p7s3_6.txt")

fout1 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\\rest genes\p7s3_6_new.txt", "w+")
...
ps = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\\rest genes\p7s3_6_new.txt").read().strip()
...
out1 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\\rest genes\p7s3_ji.txt", "a")
out2 = open("D:\Studies & Researches\Researches\Periodic Subgraph Mining\\rest genes\p7s3_6_u.txt", "a")
